...
public class Waehrungsumrechner extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Waehrungsumrechner frame = new Waehrungsumrechner();
	...
	public Waehrungsumrechner() {
		...
		JLabel lblEinheitenrechner = new JLabel("W\u00E4hrungsumrechner");
		...
		lblIn = new JLabel("Eingabew\u00E4hrung:");
		...
		list_in.setModel(new AbstractListModel() {
			String[] values = new String[] {"Euro", "Pfund", "Rubel", "US-Dollar"};
			public int getSize() {
		...
		lblOut = new JLabel("Ausgabew\u00E4hrung:");
